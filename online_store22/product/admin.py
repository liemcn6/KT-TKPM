...
from .models import Book, BookItem, Clothes, ClothesDesign, ClothesItem, ClothesOrigin, Electronics, ElectronicsItem, ElectronicsOrigin, Item, Product, Category, ProductItem, Shoes, ShoesDesign, ShoesItem, ShoesOrigin
